  ...
  useEffect(() => {
    const fetchImages = (
      ...
      xhr.onprogress = (event) =>
        setBlur(
          (blur) => maxBlurPerImage - (blur - 4) * (event.loaded / event.total)
        );
  ...
  return (
    ...
    >
      ...
      <div className="landingGreeting">
        ...
        <p className="desc">
          Gone are the days of complex ordering systems and outdated
        </p>
        <p className="desc">
          paper menus. It&apos;s time for the new normal, RoyalRestaurant
        </p>
